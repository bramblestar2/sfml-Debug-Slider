...
void DebugSliders::setSlidersPercentage(float a)
{
	for (int i = 0; i < sliders.size(); i++)
	{
		sliders.at(i).setPercentage(a);
	}
}
...
void DebugSliders::smoothSliders(bool a)
{
	for (int i = 0; i < sliders.size(); i++)
	{
		sliders.at(i).smoothSlider(a);
	}
}

void DebugSliders::transitionTimes(float a)
{
	for (int i = 0; i < sliders.size(); i++)
	{
		sliders.at(i).transitionSpeed(a);
	}
}
